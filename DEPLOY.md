...
- skret docs section removed 2026-09-17: canonical source is the skret repo's own `docs/` synced into the unified hub at `docs.n24q02m.com/skret/`; `/skret/*` paths 301 via `public/_redirects`.
