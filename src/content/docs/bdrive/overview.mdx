...
<CardGrid>
  <LinkCard
    title="Install"
    description="Install with release archives or package managers"
    href="https://tools.n24q02m.com/bdrive/install/"
  />
  <LinkCard
    title="Sync and restore"
    href="https://tools.n24q02m.com/bdrive/sync-restore/"
  />
  <LinkCard
    title="Source and release assets"
    href="https://github.com/n24q02m/better-drive/releases"
  />
  <LinkCard
    title="Full command/configuration reference"
    href="https://github.com/n24q02m/better-drive#configuration"
  />
</CardGrid>
