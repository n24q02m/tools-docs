...
## Continue with better-semantic-release

<CardGrid>
  <LinkCard title="Install & usage" href="/bsr/install/" description="Wire bsr into a repository workflow" />
  <LinkCard title="Action pinning" href="/bsr/pinning/" description="How to pin bsr actions safely" />
  <LinkCard title="Action-pin registry" href="/bsr/registry/" description="Verify that a pin is genuine and fresh" />
  <LinkCard title="Release channels" href="/bsr/channels/" description="Beta-first releases and stable promotion" />
</CardGrid>
