...
<CardGrid>
  <LinkCard
    title="Install and verify a release"
    href="/skret/install/"
  />
  <LinkCard
    title="Configure a project and use secrets"
    href="/skret/secrets/"
  />
  <LinkCard
    title="Full command and provider reference"
    href="https://github.com/n24q02m/skret/tree/main/docs/src/content/docs"
  />
  <LinkCard
    title="Source and release assets"
    href="https://github.com/n24q02m/skret/releases"
  />
</CardGrid>
